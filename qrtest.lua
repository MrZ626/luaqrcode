...
local prepared = qrcode.prepare_matrix_with_mask(1,1,-1)
tab, a, b, c = qrcode.get_next_free_positions(prepared,#prepared,#prepared,"up","11111111")
assert_equal(#tab,8,"get_next_free_positions count")
assert_equal(tab[1][1],21,"get_next_free_positions first x")
assert_equal(tab[1][2],21,"get_next_free_positions first y")
assert_equal(tab[8][1],20,"get_next_free_positions last x")
assert_equal(tab[8][2],18,"get_next_free_positions last y")
assert_equal(a,21,"get_next_free_positions next x")
assert_equal(b,17,"get_next_free_positions next y")
assert_equal(c,"up","get_next_free_positions next dir")
